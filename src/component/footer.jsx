          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex space-x-10 justify-center items-center mb-14">
              <Link
                ...
                smooth={true}
                duration={500}
                className="block text-gray-900 transition-all duration-500 hover:text-white cursor-pointer"
              >
                <svg
            ...
            <span className="text-lg text-gray-300 text-center block">
              ©<Link to="footer" smooth={true} duration={500}>Gsaab</Link> 2025, All rights reserved.
            </span>
          </div>
        </div>
      </footer>
