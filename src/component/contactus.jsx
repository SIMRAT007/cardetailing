            ...
            <section class="py-24" id='contact'>
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
                        <div class="flex items-center lg:mb-0 mb-10">
                            <div class="">
                                ...
                                <form onSubmit={handleSubmit} >
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-red-600 shadow transition-all duration-700 hover:bg-red-800 cursor-pointer"
                                    >
                                        Submit
                                    </button>
                                </form>
                        ...
                        >                            <div class="">
                                <div class="lg:w-96 w-auto h-auto bg-gray-200 shadow-xl lg:p-6 p-4 rounded-2xl">
                                    <img
                                        src={Logo}
                                        alt="New Logo"
                                        className="mb-6 mx-auto w-20 h-18"
                                    />
